...
import kotlinx.android.synthetic.main.votelist_result.view.*
import org.json.JSONArray


class VoteResultRecyclerAdapter: RecyclerView.Adapter<VoteResultRecyclerAdapter.ItemViewHolder>(){
    ...
    */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        val view = when (viewType) {
            ITEM -> LayoutInflater.from(parent.context).inflate(R.layout.votelist_result, parent, false)
    ...
    */
    inner class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItem(VoteData: VoteItem) {
            ...
            itemView.result_VoteName.text = VoteData.VoteName
        }
    }
